...
export const ScientificWorks: CollectionConfig<'scientific-works'> = {
  slug: 'scientific-works',
  access: {
  ...
  fields: [
      ...
      tabs: [
        {
          fields: [
            ...
            },
            {
              ...
              label: 'PDF Document',
              admin: {
                description: 'Upload a PDF document for this scientific work',
              },
            },
            {
              name: 'content',
    ...
    },
    {
      ...
      admin: {
        position: 'sidebar',
        description: 'Select related resume entries that are relevant to this scientific work',
      },
      hasMany: true,
      relationTo: 'resume',
    },
