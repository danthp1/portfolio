    ...
    <div className={`pdf-viewer relative ${className}`} style={{ width: '100%', height: '800px', minHeight: '800px' }}>
      ...
      {embedFailed && (
        <p className="text-center mt-2">
          Ihr Browser unterstützt keine PDF-Einbettung. <a href={url} target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline">PDF herunterladen</a>
        </p>
      )}
    </div>
  );
