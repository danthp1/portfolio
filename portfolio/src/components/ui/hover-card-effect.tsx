      ...
      {items.map((item, idx) => (
        ...
        >
          <AnimatePresence>
            {hoveredIndex === idx && (
              <motion.span
                className="absolute inset-0 h-full w-full bg-blue-500 block"
...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        " h-full w-full p-4 overflow-hidden bg-white border border-2  border-black text-black relative z-20",
        className,
      )}
    >
